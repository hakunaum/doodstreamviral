...
export default async function Video({ params }: PageProps) {
	...
	const jsonLd = {
        ...
        url: `https://doodstreamviral.pages.dev/v/${file.filecode}`,
        ...
        publisher: {
            '@type': 'Organization',
            name: `${SITENAME}`,
            logo: 'https://doodstreamviral.pages.dev/favicon.ico'},
            author: {
                '@type': 'Person',
                name: 'admin',
                url: 'https://doodstreamviral.pages.dev'
              }
        }
        const jsonLd2 = {
        '@context': 'https://schema.org',
